 ...
 * ===============================================================================================================
 */
public final class LocationListenerGPServices extends ILocationListener implements
        LocationListener,
    ...
    private boolean useCurrentLocation() {
        ...
        if (location != null && (System.currentTimeMillis() - location.getTime() < HALF_MINUTE)) {
